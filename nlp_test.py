...
test_example=input("Enter a comment  ")
...
if(toxic_probability>non_toxic_probability):
    print("the given comment is toxic")
else:
    print("the given comment is non-toxic")
print("toxicity  percentage is = ",(toxic_probability*100),"%")